...
This part gives short descriptions of the selected machine learning models for this analysis. Four models will be covered: logistic regression, decision tree classifier, random forest classifier and XGBoost. 
